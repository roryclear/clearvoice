...
class _BaseAutoModelClass:
    _model_mapping = _LazyAutoMapping(CONFIG_MAPPING_NAMES, MODEL_FOR_CAUSAL_LM_MAPPING_NAMES)
...
class _BaseAutoModelClass(_BaseAutoModelClass):
    @classmethod
...
model = AutoModelForCausalLM.from_pretrained("OpenMOSS-Team/MOSS-Transcribe-Diarize").to(dtype=dtype).to(device).eval()
